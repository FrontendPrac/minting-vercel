...
const Header = ({ walletToggle , navigationToggle  })=>{
    ...
    const { 0: contract , 1: setContract  } = (0,external_react_.useState)(null);
    const { 0: connectWalletText , 1: setConnectWalletText  } = (0,external_react_.useState)("CONNECT TO WALLET");
    ...
    const updateEthers = async ()=>{
        ...
        setSigner(signer);
        const contract = new external_ethers_.ethers.Contract(contractAddress, contractABI, signer);
...
const WalletPopUp = ({ walletToggle , wallet  })=>{
    const { 0: errorMessage , 1: setErrorMessage  } = (0,external_react_.useState)("You are not connected to a wallet");
    const { 0: joinWhiteListText , 1: setJoinWhiteListText  } = (0,external_react_.useState)("Join the Whitelist");
    const { 0: numofWhitelisted , 1: setNumofWhitelisted  } = (0,external_react_.useState)(null);
    const { 0: connectButtonText , 1: setConnetButtonText  } = (0,external_react_.useState)("Connect Wallet");
    const { 0: connectedAddress , 1: setConnectedAddress  } = (0,external_react_.useState)(null);
    // state management of provider , signer and contract
    const { 0: provider , 1: setProvider  } = (0,external_react_.useState)(null);
    const { 0: signer , 1: setSigner  } = (0,external_react_.useState)(null);
    const { 0: contract , 1: setContract  } = (0,external_react_.useState)(null);
